...
-- Dumping data for table qcpl_engagement.bakla_ako: ~0 rows (approximately)
INSERT INTO `bakla_ako` (`bakla_id`, `question_id`, `bakla_ako`, `is_deleted`, `created_at`, `updated_at`) VALUES
	(1, 27, 'ads', 0, '2024-02-17 20:33:03', '2024-02-17 20:33:03'),
	(2, 27, '12', 0, '2024-02-17 20:33:03', '2024-02-17 20:33:03');
...
-- Dumping data for table qcpl_engagement.client: ~39 rows (approximately)
...
-- Dumping data for table qcpl_engagement.feedback: ~2 rows (approximately)
INSERT INTO `feedback` (`feedback_id`, `client_id`, `question_id`, `emoji_id`, `text_feedback`, `created_at`, `updated_at`) VALUES
	(8, 72, 9, 109, '', '2024-02-13 07:10:55', '2024-02-13 07:10:55'),
	(9, 72, 10, 109, '', '2024-02-13 07:10:55', '2024-02-13 07:10:55');
...
INSERT INTO `questions` (`question_id`, `qt_id`, `qc_id`, `english_question`, `tagalog_question`, `is_deleted`, `created_at`, `updated_at`) VALUES
	...
	(25, 14, 4, 'zxc', 'qweqwe', 0, '2024-02-17 20:27:21', '2024-02-17 20:27:21'),
	(26, 14, 3, 'cz', 'asd', 0, '2024-02-17 20:29:00', '2024-02-17 20:29:00'),
	(27, 14, 3, 'ads', 'zcx', 0, '2024-02-17 20:33:03', '2024-02-17 20:33:03'),
	(28, 1, 2, 'asd', 'dasdasdafaa', 0, '2024-02-17 20:34:20', '2024-02-17 20:34:20'),
	(29, 15, 1, 'zcxzccxzczx', 'asd', 0, '2024-02-17 20:35:27', '2024-02-17 20:35:27');
...
-- Dumping data for table qcpl_engagement.queue: ~11 rows (approximately)
...
-- Dumping data for table qcpl_engagement.queue_details: ~33 rows (approximately)
...
-- Dumping data for table qcpl_engagement.test_choice: ~0 rows (approximately)
INSERT INTO `test_choice` (`test_id`, `question_id`, `test_choice`, `is_deleted`, `created_at`, `updated_at`) VALUES
	(1, 29, 'sadasd', 0, '2024-02-17 20:35:27', '2024-02-17 20:35:27'),
	(2, 29, 'xzc', 0, '2024-02-17 20:35:27', '2024-02-17 20:35:27');
...
INSERT INTO `users` (`user_id`, `user_role_id`, `username`, `password`, `is_active`, `last_login`, `created_at`, `updated_at`) VALUES
	(4, 1, 'admin', '$2y$10$MRaoOOnRQ69KTufCOTKo3u87J0E41e3XIIvYSr/3vG58uJ6NDtWWS', 1, '2024-02-17 20:42:08', '2023-12-28 02:52:00', '2024-02-17 20:42:08'),
